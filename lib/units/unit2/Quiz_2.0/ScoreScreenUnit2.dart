...
class _ScoreScreenState extends State<ScoreScreen>
  ...
  Widget build(BuildContext context) {
    quizUnit2scoredb(markedCorrectUnit2.length);
    var deviceHeight = MediaQuery.of(context).size.height;
    var deviceWidth = MediaQuery.of(context).size.width;
    return WillPopScope(
            ...
            child: Column(
              children: [
                ...
                Text(
                  ...
                  questionListUnit2[int.parse(_listkeys[itemIndex]) - 1]
                      .question,
                ),
                SizedBox(
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    "Your Answer: ${questionListUnit2[int.parse(_listkeys[itemIndex]) - 1].options[_listvalues[itemIndex] - 1]}",
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    "Correct Answer:  ${questionListUnit2[int.parse(_listkeys[itemIndex]) - 1].options[correctAnswers - 1]}",
