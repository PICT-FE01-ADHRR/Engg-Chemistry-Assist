...
class _QuizScreen2State extends State<QuizScreen2> {
  ...
  int pageChanged = 0;
  int gotoFirstPage = 0;
  int timeToNavigate = questionListUnit4.length * 15;
  // int timeToNavigate = 15;
  int gotoLastPage = questionListUnit4.length;
  ...
  void initState() {
    ...
    super.initState();
    Future.delayed(Duration(seconds: questionListUnit4.length * 15), () {
      Navigator.push(
  ...
  void fillSet() {
    // skippedQues.addAll()
    for (var i = 0; i < questionListUnit4.length; i++) {
      skippedQues.add(i);
    }
    print(skippedQues);
  }
          ...
          body: Column(
            children: [
              ...
              CircularPercentIndicator(
                  ...
                  percent: timeToNavigate / (questionListUnit4.length * 15),
                  center: Text(
              ...
              Expanded(
                child: PageView.builder(
                  ...
                  itemBuilder: (context, index) => QuestionSet(
                    itemIndex: index,
                    itemNum: questionListUnit4[index],
                  ),
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      fillSet();
                      if (pageChanged + 1 >= questionListUnit4.length) {
                        showDialog(
                            context: context,
                            builder: (context) {
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => AttemptedListUnit4()));
                      // }
                    },
                    child: Container(
                        alignment: Alignment.center,
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      var currectScore = markedCorrectUnit4.length;
