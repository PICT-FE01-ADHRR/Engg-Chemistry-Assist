...
import 'QuizScreen2Unit5.dart';
// import 'package:engg_chemistry_study_assist/units/unit1/Quiz_2.0/ScoreScreen.dart';
import 'package:flutter/material.dart';

// ignore: must_be_immutable
class AttemptedListUnit5 extends StatelessWidget {
  PageController pageController = PageController(initialPage: 0);

  AttemptedListUnit5({super.key});
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    if (tappedMapUnit5.length == questionListUnit5.length) {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
...
class DisplayAllQuestions extends StatelessWidget {
  ...
  String otherThanMarked() {
    if (tappedMapUnit5.containsKey(itemIndex)) {
      return "Answered";
    } else {
      return "Not Answered";
    }
            ...
            child: Row(
              ...
              children: [
                Container(
                  ...
                  child: Text(
                    "Question - ${questionListUnit5[itemIndex].id}",
