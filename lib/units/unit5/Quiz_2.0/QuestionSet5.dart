            ...
            (index) => Option(
              ...
              press: () {
                ...
                if ((index + 1 == widget.itemNum.correctAns)) {
                  ...
                  markedCorrectUnit5.add(qId);
                } else {
                  qId = widget.itemNum.id;
                  markedWrongUnit5.add(qId);
                  markedWrongAnserUnit5["$qId"] = index + 1;
                  // print(markedWrongAnserUnit5);
                  // print(markedWrongUnit5);
                  // print("Wrong $markedWrongUnit5");
                }

                if (markedWrongUnit5.contains(widget.itemNum.id)) {
                  if (markedCorrectUnit5.contains((widget.itemNum.id))) {
                    markedWrongUnit5.remove(widget.itemNum.id);
                    markedWrongAnserUnit5.remove("$qId");
                    // this.setState(() {
                    //   tapped.remove("$qId");
                    // });
                  }
                ...
                // print("***************");
                // print(tappedMapUnit5);
                // print("***************");

                // Option.isAnswered = true;
                //     markedCorrectUnit5.contains(itemNum.id)) {
                //   markedCorrectUnit5.remove(itemNum.id);
                // }
              },
            ),
          ),
