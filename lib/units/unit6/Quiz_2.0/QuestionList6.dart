...
import 'QuizScreen2Unit6.dart';
// import 'package:engg_chemistry_study_assist/units/unit1/Quiz_2.0/ScoreScreen.dart';
import 'package:flutter/material.dart';

// ignore: must_be_immutable
class AttemptedListUnit6 extends StatelessWidget {
  PageController pageController = PageController(initialPage: 0);

  AttemptedListUnit6({super.key});
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    if (tappedMapUnit6.length == questionListUnit6.length) {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
...
class DisplayAllQuestions extends StatelessWidget {
  ...
  String otherThanMarked() {
    if (tappedMapUnit6.containsKey(itemIndex)) {
      return "Answered";
    } else {
      return "Not Answered";
    }
            ...
            child: Row(
              ...
              children: [
                Container(
                  ...
                  child: Text(
                    "Question - ${questionListUnit6[itemIndex].id}",
