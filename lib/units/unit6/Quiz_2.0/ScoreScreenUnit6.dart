...
class ScoreScreen extends StatefulWidget {
  ...
  var score = markedCorrectUnit6.length;
  // var score = 5;
...
class _ScoreScreenState extends State<ScoreScreen>
  ...
  Text greetUser() {
    if (widget.score > questionListUnit6.length * 0.8) {
          ...
          body: Column(
            children: [
                ...
                children: [
                  ...
                  AnimatedContainer(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        "SCORE: ${widget.score}/${questionListUnit6.length}",
                        style: TextStyle(
                            color: Colors.white,
              ...
              ElevatedButton(
                ...
                onPressed: () {
                  // var count = 0;
                  tappedMapUnit6.clear();
                  markedWrongUnit6.clear();
                  markedCorrectUnit6.clear();
                  markedWrongAnserUnit6.clear();
              ...
              Expanded(
                child: ListView.builder(
                    itemCount: markedWrongUnit6.length,
                    // itemCount: 5,
...
class DisplayWrongQuestions extends StatelessWidget {
  ...
  final _listvalues = markedWrongAnserUnit6.values.toList();
  final _listkeys = markedWrongAnserUnit6.keys.toList();

  // void getWrongIndex() {
  //   // for (var num in temp) {
  //   //   print(num - 1);
  //   //   // print(questionListUnit6[num - 1].question);
  //   // }
  ...
  Widget build(BuildContext context) {
    final correctAnswers =
        questionListUnit6[int.parse(_listkeys[itemIndex]) - 1].correctAns;
    var deviceWidth = MediaQuery.of(context).size.width;
    var deviceHeight = MediaQuery.of(context).size.height;
    return Container(
      // color: Colors.black,
            ...
            child: Column(
              children: [
                ...
                Text(
                  ...
                  questionListUnit6[int.parse(_listkeys[itemIndex]) - 1]
                      .question,
                ),
                SizedBox(
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    "Your Answer: ${questionListUnit6[int.parse(_listkeys[itemIndex]) - 1].options[_listvalues[itemIndex] - 1]}",
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    "Correct Answer:  ${questionListUnit6[int.parse(_listkeys[itemIndex]) - 1].options[correctAnswers - 1]}",
