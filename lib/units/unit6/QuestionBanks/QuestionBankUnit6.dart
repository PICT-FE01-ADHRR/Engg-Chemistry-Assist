...
class QuestionBankUnit6 extends StatelessWidget {
  const QuestionBankUnit6({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Study Material Unit 6'),
        backgroundColor: const Color(0xFF0a1931),
      ),
      body: Column(
        children: [
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const StudyMaterialUnit6(),
                  ),
                );
              },
              child: Container(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const QuestionBankUnit61(),
                  ),
                );
              },
              child: Container(
