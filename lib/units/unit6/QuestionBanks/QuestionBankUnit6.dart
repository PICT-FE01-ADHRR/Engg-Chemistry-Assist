...
import 'QuestionBankUnit6_1.dart';
import 'QuestionBankUnit6_2.dart';
...
class QuestionBankUnit6 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Study Material Unit 6'),
        backgroundColor: Color(0xFF0a1931),
      ),
      body: Column(
        children: [
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => StudyMaterialUnit6(),
                  ),
                );
              },
              child: Container(
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => QuestionBankUnit61(),
                  ),
                );
              },
              child: Container(
            ...
            child: GestureDetector(
              onTap: () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => QuestionBankUnit62(),
                  ),
                );
              },
              child: Container(
