          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    if (tappedMapUnit3.length == questionListUnit3.length) {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
...
class DisplayAllQuestions extends StatelessWidget {
  ...
  String otherThanMarked() {
    if (tappedMapUnit3.containsKey(itemIndex)) {
      return "Answered";
    } else {
      return "Not Answered";
    }
            ...
            child: Row(
              ...
              children: [
                Container(
                  ...
                  color: Colors.white,
                  child: Text(
                    "Question - ${questionListUnit3[itemIndex].id}",
