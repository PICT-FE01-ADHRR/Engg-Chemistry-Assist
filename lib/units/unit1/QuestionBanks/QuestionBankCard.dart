...
import '../Content_Data/QuestionBankQuestions.dart';
                          ...
                          children: [
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Column(
                                        children: [
                                          Text(questionList[index].options[1],
                                              style: TextStyle(fontSize: 15))
                                        ],
                                      ),
                                    ),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Column(
                                        children: [
                                          Text(questionList[index].options[3],
                                              style: TextStyle(fontSize: 15))
                                        ],
                                      ),
                                    ),
                            ...
                            RichText(
                              text: TextSpan(
                                ...
                                children: [
                                  TextSpan(
                                    text: questionList[index].options[questionList[index].correctAns-1],
                                    style: TextStyle(
