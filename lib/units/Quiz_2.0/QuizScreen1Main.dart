...
class QuizScreen1Main extends StatefulWidget {
  const QuizScreen1Main({Key? key}) : super(key: key);

  @override
  _QuizScreen1MainState createState() => _QuizScreen1MainState();
}

class _QuizScreen1MainState extends State<QuizScreen1Main> {
